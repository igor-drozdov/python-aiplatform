...
class OpenModel:
    ...
    def check_license_agreement_status(self) -> bool:
        ...
        response = self._model_garden_client.check_publisher_model_eula_acceptance(request)
        return response.publisher_model_eula_acked

    def accept_model_license_agreement(self) -> types.model_garden_service.PublisherModelEulaAcceptance:
