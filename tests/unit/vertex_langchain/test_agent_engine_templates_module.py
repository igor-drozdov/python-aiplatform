...
from google.cloud.aiplatform.tests.unit.vertex_langchain import test_constants

_TEST_MODULE_NAME = "google.cloud.aiplatform.tests.unit.vertex_langchain.test_constants"
...
class TestModuleAgent:
    ...
    def test_query(self):
        ...
        expected_result = test_constants.test_agent.query(input=_TEST_QUERY_INPUT)
        assert got_result == expected_result
    ...
    def test_stream_query(self):
        ...
        for got_result, expected_result in zip(
            agent.stream_query(n=_TEST_STREAM_QUERY_INPUT),
            test_constants.test_agent.stream_query(n=_TEST_STREAM_QUERY_INPUT),
        ):
            assert got_result == expected_result
